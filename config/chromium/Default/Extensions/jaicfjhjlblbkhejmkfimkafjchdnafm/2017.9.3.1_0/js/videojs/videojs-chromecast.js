...
var ChromeCastButton = (function (_Button) {
    ...
    function ChromeCastButton(player, options) {
        ...
        //     if (_this.casting && _this.apiSession) {
        //         _this.apiSession.stop(null, null);
        //         $('#videoRefresh, #playbackRateContainer').show();
        //     }
        // });
    ...
    _createClass(ChromeCastButton, [{
        ...
        value: function onSessionSuccess(session) {
            ...
            /* == == */
            _videoJs2['default'].log('Hiding incompatible elements.');
            $('#videoRefresh, #playbackRateContainer').hide();
            /* == == */
        ...
        value: function onStopAppSuccess() {
            ...
            /* == == */
            _videoJs2['default'].log('Showing hidden elements.');
            $('#videoRefresh, #playbackRateContainer').show();
            /* == == */
